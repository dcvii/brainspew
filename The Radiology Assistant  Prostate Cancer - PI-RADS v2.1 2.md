---
title: "The Radiology Assistant : Prostate Cancer - PI-RADS v2.1"
source: https://radiologyassistant.nl/abdomen/prostate/prostate-cancer-pi-rads-v2-1
author:
  - "[[Guidelines for authors]]"
published: 2018-08-01. Update 2023-07-01
created: 2026-03-07
description:
tags:
  - brain_spew
...
![](https://radiologyassistant.nl/assets/tab-pirads-1683713102.png)
...
![](https://radiologyassistant.nl/assets/-1-tab-pi-rads-2.1.png)

### PI-RADS version 2.1

The table is based on the PI-RADS version 2.1.  
Changes from the old version 2.0 are indicated in light red.

**Assessment by Zonal Anatomy  
**Correct identification of the anatomic zone (Peripheral Zone vs Transition Zone) is critical, as the dominant sequence used to determine PI-RADS score varies by location.

**Peripheral zone (PZ)  
**The peripheral zone is situated on the posterior and lateral side of the prostate, surrounding the transition zone.  
In the Peripheral Zone, DWI/ADC is the dominant sequence.

- Lesions scored PI-RADS 3 based on DWI/ADC:
- Remain PI-RADS 3 if DCE is negative
	- Are upgraded to PI-RADS 4 if DCE is positive (i.e., early focal enhancement)

Updates in PI-RADS v2.1:
...
In the Transition Zone, T2-weighted imaging is the dominant sequence.

PI-RADS Category Adjustment Based on DWI/ADC:

- A T2W score 2 lesion:
- Remains PI-RADS 2 if DWI/ADC ≤ 3
	- Becomes PI-RADS 3 if DWI/ADC ≥ 4
- A T2W score 3 lesion:
- Remains PI-RADS 3 if DWI/ADC < 5
	- Becomes PI-RADS 4 if DWI/ADC = 5

  
Updates in PI-RADS v2.1:

- Round, fully encapsulated nodules are now assigned PI-RADS 1.
- More precise criteria for category 2 lesions.

![](https://radiologyassistant.nl/assets/-tab-nieuw-1686336649.png)
...
![](https://radiologyassistant.nl/assets/tab-peripheral-1.png)
...
![](https://radiologyassistant.nl/assets/tab-peripheral-2.png)
...
![](https://radiologyassistant.nl/assets/tab-peripheral-3.png)
...
![](https://radiologyassistant.nl/assets/tab-peripheral-4.png)
...
![](https://radiologyassistant.nl/assets/tab-peripheral-5.png)
...
![](https://radiologyassistant.nl/img/containers/main/-1-tab-examples-peripheral-zone.jpg/3a4c58f7a6cb044d3926c931e0792302.jpg)
...
![](https://radiologyassistant.nl/assets/_pz-ca-1.jpg)
...
![](https://radiologyassistant.nl/assets/_pz-ca-2.jpg)
...
![](https://radiologyassistant.nl/assets/_pz-ca-3.jpg)
...
![](https://radiologyassistant.nl/assets/tab-transition-1-1683704238.png)
...
![](https://radiologyassistant.nl/assets/tab-transition-2-1683647438.png)
...
![](https://radiologyassistant.nl/assets/tab-transition-3-1683647450.png)
...
![](https://radiologyassistant.nl/assets/tab-transition-4-1683647460.png)
...
![](https://radiologyassistant.nl/assets/tab-transition-5-1683647466.png)
...
![](https://radiologyassistant.nl/img/containers/main/-1-tab-examples-1-transition-zone.jpg/cc62afe93de34617af6b2102721620e3.jpg)
...
![](https://radiologyassistant.nl/img/containers/main/-1-tab-examples-2-transition-zone.jpg/49e3c5cadbd787889206d9034d313937.jpg)
...
![](https://radiologyassistant.nl/assets/_tz-ca-1.jpg)
...
![](https://radiologyassistant.nl/assets/-1-tz-prostateca.jpg)
...
![](https://radiologyassistant.nl/assets/-1-tz-prostateca-2.jpg)
...
![](https://radiologyassistant.nl/assets/-1afms-2.jpg)
...
![](https://radiologyassistant.nl/assets/-1afms-1687434055.jpg)
...
![](https://radiologyassistant.nl/assets/prostate-cancer-pi-rads-v2/a5aeefa5bf2ce3___12-Staging.png)
...
The full table is found [here](https://cancerstaging.org/references-tools/quickreferences/Documents/ProstateSmall.pdf)

![Poorly differentiated adenocarcinoma of the prostate](https://radiologyassistant.nl/assets/_advanced-ca.jpg) *Poorly differentiated adenocarcinoma of the prostate*
...
![](https://radiologyassistant.nl/assets/prostate-cancer-pi-rads-v2/a5b48a5c9247d9_locally_advanced.001.jpeg)
...
![](https://radiologyassistant.nl/img/containers/main/prostate-cancer-pi-rads-v2/a5b5b507befa4c____locally-advanced-vesiculae.jpg/69bca6324b4ac2f9fbcacba1495b56c2.jpg)
...
![](https://radiologyassistant.nl/img/containers/main/prostate-cancer-pi-rads-v2/a5b2b90c62993b____TEK-Lnn.jpg/edf4e39482fd63fd06e87dbf04414f0d.jpg)
...
![](https://radiologyassistant.nl/img/containers/main/prostate-cancer-pi-rads-v2/a5b5c31582906a____BPH2.jpg/455990acb9342c7983c76a5802f2d3bb.jpg)
...
![](https://radiologyassistant.nl/img/containers/main/prostate-cancer-pi-rads-v2/a5b5c417357f83____BPH2.jpg/7b4fa744217461fc88aec4d5881e3658.jpg)
...
![](https://radiologyassistant.nl/assets/_bph-in-pz.jpg)
...
![](https://radiologyassistant.nl/assets/-1-cysts-2.jpg)
...
![](https://radiologyassistant.nl/assets/-bph-cystic.jpg)
...
![](https://radiologyassistant.nl/assets/prostate-cancer-pi-rads-v2/a5aeee655150c1___9TAB-prostatitis.png)
...
![Differences between prostatitis ( images on the left) and  prostate cancer (images on the right)](https://radiologyassistant.nl/assets/_prostatitis-vs-ca.jpg) *Differences between prostatitis ( images on the left) and prostate cancer (images on the right)*
...
![](https://radiologyassistant.nl/assets/_prostatitis.jpg)
...
![](https://radiologyassistant.nl/assets/_prostatitis-2.jpg)
...
![](https://radiologyassistant.nl/assets/_abscess.jpg)
...
![Hemorrhage. The DCE image is prior to contrast enhancement.](https://radiologyassistant.nl/assets/-1-hemorrhage.jpg) *Hemorrhage. The DCE image is prior to contrast enhancement.*
...
![](https://radiologyassistant.nl/assets/-1-cysts.jpg)
...
![](https://radiologyassistant.nl/assets/prostate-cancer-pi-rads-v2/a5a08430ea73a0_1B-PSA-density.png)
...
![](https://radiologyassistant.nl/assets/_volume.jpg)
...
![](https://radiologyassistant.nl/assets/tab-mr-protocol.png)
...
![](https://radiologyassistant.nl/assets/_preparation.jpg)
...
![](https://radiologyassistant.nl/assets/_preparation-2.jpg)
...
![](https://radiologyassistant.nl/assets/_t1w-tra.jpg)
...
![](https://radiologyassistant.nl/assets/mets.jpg)
...
![](https://radiologyassistant.nl/assets/dwi.jpg)
...
![Modified criteria for a negative score on DCE in PI-RADS v2.1 are in italic. Criteria for a positive score on DCE remain unchanged.](https://radiologyassistant.nl/assets/tab-dce.png) *Modified criteria for a negative score on DCE in PI-RADS v2.1 are in italic. Criteria for a positive score on DCE remain unchanged.*
...
![](https://radiologyassistant.nl/img/containers/main/_term-marked.jpg/8014949f0dac7ed6768ec8bfb45a0853.jpg)
...
![](https://radiologyassistant.nl/img/containers/main/-1-ill-defined-1687437636.jpg/d5a1d56853809ebfff6f64e8f3ebfe79.jpg)

**Non-circumscribed  
**Non-circumscribedmeans **"** Ill-defined”

**Image**  
A non-circumscribed region (ill-defined) shows restriction of diffusion corresponding to a PI-RADS 3 nodule.

![](https://radiologyassistant.nl/img/containers/main/_term-wedge.jpg/489b76656777b71c75fbbeaeb01fe20b.jpg)

**Wedge** in the peripheral zone is defined as “having the shape of a wedge, pie, or V shaped”

![](https://radiologyassistant.nl/img/containers/main/_term-focal-1683711448.jpg/eb3a071960e00dfb25ec6ee0d2439dfa.jpg)
...
![](https://radiologyassistant.nl/assets/-1-linear-1687437950.jpg)
...
![](https://radiologyassistant.nl/img/containers/main/_term-lenticular.jpg/4518c4c1e4feb39521ab3507bc6865ea.jpg)

**Lenticular** is defined as having the shape of a double-convex lens, crescentic.

![](https://radiologyassistant.nl/img/containers/main/_term-completely-encapsulated.jpg/7ff1967b2101ce54d575816dd7188670.jpg)
...
![](https://radiologyassistant.nl/img/containers/main/_term-almost-encapsulated.jpg/06128169bb6d003ab4e9d6b2715d270d.jpg)
...
![](https://radiologyassistant.nl/img/containers/main/-1-hypointense-area-1687438175.jpg/ca0568d3d00e6e660cc0c86f5119bbd7.jpg)
...
![](https://radiologyassistant.nl/img/containers/main/-1-heterogeneous-signal-1687438504.jpg/233234feafd4a436a09d151bdd2b46fc.jpg)
...
![](https://radiologyassistant.nl/assets/prostate-cancer-pi-rads-v2/a5b276e3ed7b35____TAB-Check.png)
