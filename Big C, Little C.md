...
<iframe src="https://www.youtube-nocookie.com/embed/Wwpivqrw6KU?rel=0&amp;autoplay=0&amp;showinfo=0&amp;enablejsapi=0" frameborder="0" allow="autoplay; fullscreen" allowfullscreen="true" width="728" height="409"></iframe>

**PSA - The First Indicator  
**This started somewhere around October of last year. I funded my last quarter of the year and took a vacation in New Orleans. When I came back I had a doctor’s appointment and blood work that showed my **Prostate Specific Antigen** (PSA) index was around 6.2, when it should be below 4 at my age. He recommended that I should go see a urologist, which I did. By the standard hand-in-butt examination Dr. E told me that I’m normal sized which was a good sign. As I am registered to UCLA Health, which is one of the best in the country, I’ve gotten swift referrals. So my next stop was to get an MRI. I figured I should delay that until the new year so I could enjoy my holidays.
...
I switched to UCLA Health and they gave me a kid who finished in Grenada, which is basically the lowest bush league doctors. I only say that because I dated a pre-med who flunked her boards the first time, and said the only school that would give her a second chance was St. George’s. Anyway I could only put up with him for a year. My current primary, Dr. R is just right. An avid runner who is about ten years older than I am, we grew up in the same neighborhood. He always brings in his assistant. These seven years I have learned a lot about talking to doctors and providers of all sorts from emergency rooms, to managed care facilities, to psych wards to the ladies who change my father’s diapers.

So I’m the one, every time my father goes to the ER or to see one of his specialists (once every other month) I come back to have a discussion with Grok, ChatGPT and Claude and figure out which one to heed most. Then I send out the email.
...
When I’m finally called in, I see the magical machine everyone has been talking about. My doctor is the guy who invented it. It’s an ultrasound for men. So I’m getting a [TransRectal Prostatic Ultrasonography](https://pubmed.ncbi.nlm.nih.gov/34033331/), a Prostatic Biopsy and an [Artemis MRI Fusion Biopsy](https://uciurology.com/urological-cancers/artemis-biopsy/). But first, doc can I get some Xylocaine?

![Prostate Fusion Biopsy by Dr. Razdan - Prostate Cancer Treatment](https://substackcdn.com/image/fetch/$s_!ZHH0!,w_424,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F0cc3021d-de12-44c2-a9db-6fde9bbf8fff_768x384.png)

Prostate Fusion Biopsy by Dr. Razdan - Prostate Cancer Treatment
...
> Active surveillance (AS)—the vigilant deferral of definitive treatment—was proposed in the 1990s as a management strategy for some men with prostate cancer (PCa).[<sup>1-3</sup>](https://www.auajournals.org/doi/10.1097/#R1%20R2%20R3) AS was originally intended for men with “insignificant” cancers,[<sup>2</sup>](https://www.auajournals.org/doi/10.1097/#R2) and selection criteria were stringent.[<sup>4</sup>](https://www.auajournals.org/doi/10.1097/#R4) However, as long-term safety data have become available, selection criteria have become less restrictive.[<sup>5,6</sup>](https://www.auajournals.org/doi/10.1097/#R5%20R6) The term “insignificant” has largely been replaced by “low and intermediate risk,” and enrollment in AS programs has burgeoned over the past decade.[<sup>7</sup>](https://www.auajournals.org/doi/10.1097/#R7) Since 1 in 8 American men will be diagnosed with PCa in their lifetime and since with contemporary biopsy, low/intermediate risk is now the PCa most commonly found,[<sup>8</sup>](https://www.auajournals.org/doi/10.1097/#R8) AS is of increasing importance.
...
![](https://substackcdn.com/image/fetch/$s_!VSk0!,w_424,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ff878bbb5-d7a5-4af5-ad4c-1b396051c492_990x268.jpeg)
...
![](https://substackcdn.com/image/fetch/$s_!cUQo!,w_424,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Faa390cf3-44d0-48b2-a39c-b5b395793bae_850x520.png)
...
Since my father has it, my son might get it. In the meantime there’s a new genomic classification technique called [Decipher Prostate](https://decipherbio.com/). Surly, the more broadly this will clarify racial characterization and bring it down to more specific identifiers. Since they have my 17 cores in custody, I’ll get this additional test for free.
...
![](https://substackcdn.com/image/fetch/$s_!BZ8j!,w_424,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F1d9ba522-fd19-4bed-82d4-008bd8804a32_1635x944.jpeg)