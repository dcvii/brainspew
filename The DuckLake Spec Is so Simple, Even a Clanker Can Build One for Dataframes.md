...
source: "https://ducklake.select/2026/05/04/ducklake-dataframe/"
author:
  - "[[Pedro Holanda]]"
  - "[[Dr. Peter van Holland]]"
published: 2026-05-03
created: 2026-05-14
description: "We are showcasing the simplicity of DuckLake's v1.0 specification by developing a dataframe reader/writer with AI."
tags:
  - "brain_spew"
---
*TL;DR: We are showcasing the simplicity of DuckLake's v1.0 specification by developing a dataframe reader/writer with AI.*

One of the beauties of DuckLake is how [simple](https://ducklake.select/manifesto/#simplicity) it is. You can think of a DuckLake implementation as an orchestrator: for a given query it tells you which Parquet files to read, and when you write, you tell it which Parquet files you produced. That's roughly it. A bunch of queries hold the whole thing together.

That simplicity got me thinking: since a DuckLake implementation is fairly contained, it might be a good fit to be built by a clanker (if you don't get the reference, stop reading this blog post and go watch Star Wars). There is a full [specification](https://ducklake.select/docs/stable/specification/introduction.html) and a reference implementation, and it can even steal the queries from there. To try this out, I got Claude Opus and created my evil intern counterpart: [Dr. Peter van Holland](https://github.com/petervanholland/).
...
[![Dr. Peter van Holland, as he imagines himself](https://ducklake.select/images/blog/ducklake_dataframe_intern.png)](https://ducklake.select/images/blog/ducklake_dataframe_intern.png)
...
All the code, documentation, and tutorials have been written by Peter. Even the initial releases were managed by Peter. You can check the library [GitHub's repository](https://github.com/pdet/ducklake-dataframe), its [documentation](https://github.com/pdet/ducklake-dataframe/wiki), the [Pandas tutorial](https://github.com/pdet/ducklake-dataframe/blob/main/examples/tutorial_pandas.ipynb), and [the rest of the examples](https://github.com/pdet/ducklake-dataframe/blob/main/examples/).
