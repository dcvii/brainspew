...
source: "https://www.dwarkesh.com/p/dylan-patel?publication_id=69345&post_id=190839917&isFreemail=true&r=7br8e&triedRedirect=true"
author:
  - "[[By Dwarkesh Patel]]"
published:
created: 2026-03-13
...
- [Labelbox](https://labelbox.com/dwarkesh) noticed that even when voice models *[appear](https://labelbox.com/dwarkesh)* to take interruptions in stride, their performance degrades. To figure out why, they built a new evaluation pipeline called EchoChain. EchoChain diagnoses voice models’ specific failure modes, letting you understand what your model needs to truly handle interruptions. Check it out at [labelbox.com/dwarkesh](https://labelbox.com/dwarkesh).
...
When you look at Anthropic, they’re at $20 billion ARR. The margins are sub-50 percent, at least as [last reported by](https://www.theinformation.com/briefings/anthropic-lowered-gross-margin-projection-costs-run-ai-rose) *[The Information](https://www.theinformation.com/briefings/anthropic-lowered-gross-margin-projection-costs-run-ai-rose)*. So that’s $13 or $14 billion of compute that it’s running on rental cost-wise, which is actually $50 billion worth of CapEx that someone laid out for Anthropic to generate their current revenue.
