---
title: "Legible Forager Stories"
source: "https://www.overcomingbias.com/p/legible-forager-stories?publication_id=1245641&post_id=202213336&isFreemail=true&r=7br8e&triedRedirect=true"
author:
  - "[[Robin Hanson]]"
published: 2026-06-15
created: 2026-06-15
description: "To prevent dominators from taking over bands, early human foragers used language and weapons to empower a talky collective to coordinate to watch for and then punish moves toward such takeovers."
tags:
  - "brain_spew"
---
To prevent dominators from taking over bands, early human foragers [used](https://www.overcomingbias.com/p/hail-christopher-boehmhtml) language and weapons to empower a talky collective to coordinate to watch for and then punish moves toward such takeovers. This capacity was then also used to enforce other norms. However, once this power center existed, it created incentives for alliances to form to grab this power, to suppress rivals and control others. Though such powers had to be used and justified via the appearance of helping the band, and enforcing norms.
