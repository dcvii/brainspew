---
title: "Example Usage — Apache DataFusion  documentation"
source: "https://datafusion.apache.org/user-guide/example-usage.html#example-usage"
author:
published:
created: 2025-02-28
description:
...
Find latest available Datafusion version on [DataFusion’s crates.io](https://crates.io/crates/datafusion) page. Add the dependency to your `Cargo.toml` file:
...
See [the SQL API](https://datafusion.apache.org/library-user-guide/using-the-sql-api.html) section of the library guide for more information on the SQL API.
...
Many of DataFusion’s public APIs use types from the [`arrow`](https://docs.rs/arrow/latest/arrow/) and [`parquet`](https://docs.rs/parquet/latest/parquet/) crates, so if you use `arrow` in your project, the `arrow` version must match that used by DataFusion. You can check the required version on [DataFusion’s crates.io](https://crates.io/crates/datafusion) page.
...
To illustrate this behavior, consider the [`capitalized_example.csv`](https://datafusion.apache.org/_downloads/3cce4d737d8c5814f5b50d859d21ba53/capitalized_example.csv) file:
